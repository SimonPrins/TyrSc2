...
namespace Tyr.Tasks
{
    public class GasWorkerTask : Task
    {
        ...
        {
            UpdateGas();
            if (Base.ResourceCenter == null || Base.ResourceCenter.Unit.BuildProgress < 0.9 || Base.UnderAttack)
                return false;
            return Gas != null;
        }
        ...
        {
            if (Gas != null && !Tyr.Bot.UnitManager.Agents.ContainsKey(Gas.Unit.Tag))
                Gas = null;
