...
namespace Tyr.Builds.Protoss
{
    public class PvZZealotArchon : Build
    {
        ...
        private BuildList MainBuild()
        {
            ...
            result.Building(UnitTypes.FORGE, () => EarlyPool.Get().Detected || AggressiveZerglings);
            result.Building(UnitTypes.PHOTON_CANNON, Natural, NaturalDefensePos, 2, () => EarlyPool.Get().Detected || AggressiveZerglings);
            ...
            result.Building(UnitTypes.NEXUS);
            result.Building(UnitTypes.FORGE, () => !EarlyPool.Get().Detected);
