...
namespace SC2Sharp.Builds.Protoss
{
    public class PvTDisruptor : Build
    {
        ...
        private BuildList CannonDefense()
        {
            ...
            result.If(() => Count(UnitTypes.STALKER) >= 6 && (Bot.Main.EnemyStrategyAnalyzer.TotalCount(UnitTypes.BANSHEE) > 0 || Bot.Main.EnemyStrategyAnalyzer.TotalCount(UnitTypes.REAPER) >= 3));
